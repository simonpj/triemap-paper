...
\newcommand{\js}[1]{{\bf JS}: #1 {\bf End JS}}
\newcommand{\rae}[1]{{\bf RAE}: #1 {\bf End RAE}}
\newcommand{\sg}[1]{{\bf SG}: #1 {\bf End SG}}
...
to return only the most-specific matches.  We simply modify the definition \lstinline{lkMExprS} from \Cref{sec:matching-lookup} as follows:
\begin{code}
lkMExprS e (psubst, mt)
