...
inserted is generalised to a function \lstinline{XT a}, an
abbreviation for \lstinline{Maybe a -> Maybe a}.  This function
...
\subsection{Folds and the empty map}
...
\begin{code}
szExprS :: ExprSMap v -> Int
szExprS (ESM { esm_lit = m_lit, esm_app = m_app })
  = Map.size m_lit + ???
\end{code}
